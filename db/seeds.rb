...
Ingredient.create(name: 'Bottle and lid - glass - 33ml', category_id: 7)
Ingredient.create(name: 'Label - glass - 33ml', category_id: 7)
Productitem.create(product_id: 17, ingredient_id: 49, volume: 250, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 88, volume: 250, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 50, volume: 150, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 45, volume: 50, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 76, volume: 50, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 48, volume: 50, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 51, volume: 100, price_selector: 'latest')
Productitem.create(product_id: 17, ingredient_id: 53, volume: 100, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 66, volume: 4500, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 45, volume: 40, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 76, volume: 32, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 131, volume: 700, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 106, volume: 100, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 48, volume: 30, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 49, volume: 30, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 50, volume: 32, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 40, volume: 500, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 88, volume: 300, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 130, volume: 200, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 89, volume: 400, price_selector: 'latest')
Productitem.create(product_id: 4, ingredient_id: 59, volume: 500, price_selector: 'latest')
Productitem.create(product_id: 1, ingredient_id: 132, volume: 1, price_selector: 'average')
Productitem.create(product_id: 1, ingredient_id: 133, volume: 1, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 12, volume: 5000, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 17, volume: 2, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 19, volume: 4, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 14, volume: 2000, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 15, volume: 4, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 22, volume: 1, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 48, volume: 10, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 68, volume: 1200, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 72, volume: 30, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 105, volume: 400, price_selector: 'average')
Productitem.create(product_id: 18, ingredient_id: 49, volume: 40, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 67, volume: 2000, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 45, volume: 28, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 76, volume: 28, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 60, volume: 110, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 49, volume: 30, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 48, volume: 10, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 84, volume: 30, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 74, volume: 15, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 77, volume: 30, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 89, volume: 750, price_selector: 'average')
Productitem.create(product_id: 6, ingredient_id: 43, volume: 450, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 66, volume: 3940, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 45, volume: 50, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 76, volume: 50, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 131, volume: 300, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 49, volume: 80, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 48, volume: 35, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 91, volume: 400, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 93, volume: 75, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 130, volume: 300, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 89, volume: 400, price_selector: 'average')
Productitem.create(product_id: 5, ingredient_id: 59, volume: 500, price_selector: 'average')