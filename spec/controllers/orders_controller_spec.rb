...
describe OrdersController do
  ...
  let(:valid_attributes) { { "collection_date" => "2015-09-26" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "collection_date" => "invalid value" }}, valid_session
        assigns(:order).should be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        Order.any_instance.should_receive(:update).with({ "collection_date" => "2015-09-26" })
        put :update, {:id => order.to_param, :order => { "collection_date" => "2015-09-26" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Order.any_instance.stub(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "collection_date" => "invalid value" }}, valid_session
        assigns(:order).should eq(order)
      end
