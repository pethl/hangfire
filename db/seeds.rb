...
Ingredient.create(name: 'Texas Hot Links0', category_id: 10)
...
Ingredient.create(name: 'Lamb Gravy/Stock', category_id: 6)
...
Ingredient.create(name: 'Tomato purée', category_id: 6)
...
Ingredient.create(name: 'Bottle & lid - glass - 33ml', category_id: 7)
